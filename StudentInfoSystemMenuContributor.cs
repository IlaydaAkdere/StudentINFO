...
namespace StudentInfoSystem.Web.Menus;

public class StudentInfoSystemMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public StudentInfoSystemMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<StudentInfoSystemResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                StudentInfoSystemMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
